<template>
  <div style="display: flex; flex-direction: column; height: 100vh">
    <header>
      <div style="height: 60px; background: darkgrey">
    ...
    <div style="background: black; flex: 1; overflow-y: auto">
      <h2 class="welcome">The Chatbox</h2>
    ...
    <footer>
      <div style="min-height: 60px; background: black">
